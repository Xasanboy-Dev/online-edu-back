        ...
        <div className='w-full h-full bg-gradient bg-cover bg-center text-gray-400 text-3xl'>
            ...
            <nav className='w-full p-6 text-gray-600 flex justify-center'>
                <form className=''>
                    <select
                        ...
                        value={value}
                        className='mr-4 w-54 transiton-250 outline-none rounded bg-transparent border-2 border-white/30 '
                    >
                    ...
                    <button
                        ...
                        className='pr-3 py-0.5 pl-1 hover:bg-black/20 transiton w-40 transiton duration rounded bg-transparent border-2 border-white/30'
                    >
                        {show ? 'Yashirish' : 'Hammasi'}
                    </button>
                </form>
            </nav>
            ...
            <div className='p-4 w-full '>
                <div className='flex items-center'>
                    <li className='list-none pr-2 text-lg'>
