...
const RegistartionWorker = () => {
  return (
    ...
    <div className='sm:w-[400px] h-[500px] bg-transparet border-4  border-blue-600 max-sm:w-[280px] h-min rounded-xl text-md px-2'>
       ...
       <form className=' w-full h-min rounded-b-xl px-2 pt-3 flex flex-col gap-2 items-center'>
         ...
         <input className='w-full rounded max-sm:h-8 h-12 p-2 bg-transparent border border-white outline-none mb-2' type="text" placeholder='Title' />
           ...
           <div className='w-full'>
                ...
                <select className='w-full rounded max-sm:h-8 h-12 px-2 bg-transparent border border-white outline-none' name=""> 
                   <option className='pt-1 px-2 bg-sky-400' value="1">Bugalteriya</option>
                   <option className='pt-1 px-2 bg-sky-400' value="1">Sotuv bo'limi</option>
                   <option className='pt-1 px-2 bg-sky-400' value="1">Assitent</option>
               </select>
           </div>  
           <div className='w-full'>
                <h1>O'qtuvchilar:</h1>
...
export default RegistartionWorker