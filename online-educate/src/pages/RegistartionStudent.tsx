...
const RegistartionStudent = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (
            ...
            setMessage(text)
            if (text == 'Muvafaqiyatli registratsiyadan otdingiz') {
                navigate('/login')
                return
            }
        } else {
            ...
            <div className='sm:w-[400px] h-[500px] bg-transparet border-4  border-blue-600 max-sm:w-[280px] h-min rounded-xl text-md px-2'>
                ...
                >
                    ...
                    <div className='flex'>
                        ...
                        >
                            Your password must be longer than 6
                        </span>
                        <span
                            className='text-red-700'
                    ...
                    <span className='underline decoration-1 flex justify-content-center'>
                        <NavLink to={'/login'}>Logindan otish</NavLink>
                    </span>
                </form>
            </div>
        </div>
