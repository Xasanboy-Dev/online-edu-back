...
export default function Comment() {
    let comments: { text: string, createdDate: string, ownerName: string, ownerID: number }[] = [
        {
            text: "hello World",
