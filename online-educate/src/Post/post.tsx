    ...
    return (
        <div className="my-5 ">
            <div className="mt-[15px] pb-[25px] border  border-black rounded w-[95%] mx-auto">
                <div className="border mx-5 px-5 py-2 my-2 rounded  justify-between flex items-center  border-black">
                    <div className=" mx-5">
                ...
                {user.video !== "" && <video autoPlay muted controls className="w-[95%] h-[65vh] h-auto flex mx-auto my-5 rounded" src={`${video.url}`} />}
                {photo.url && <img src={photo.url} className="rounded w-auto h-[75%] border- flex mx-auto my-5" />}
                <div className=" 5 flex  rounded items-center justify-between w-full">
                    ...
                    <button className="mx-auto border border-black px-4 py-2 rounded">Read the comments</button>
                </div>
            </div>
        </div >
    )
